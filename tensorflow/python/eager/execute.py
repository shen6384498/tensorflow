...
def quick_execute(op_name, num_outputs, inputs, attrs, ctx, name=None):
    ...
    """
    print("hello boy ***************************** quick_execute start")
    device_name = ctx.device_name
    # pylint: disable=protected-access
    try:
        ctx.ensure_initialized()
        print("hello boy ***************************** TFE_Py_Execute start")
        tensors = pywrap_tfe.TFE_Py_Execute(ctx._handle, device_name, op_name,
                                            inputs, attrs, num_outputs)
        print("hello boy ***************************** TFE_Py_Execute end")
    ...
    print("hello boy ***************************** quick_execute end")
    return tensors
...
def make_shape(v, arg_name):
    ...
    try:
        ...
        raise TypeError(
            "Error converting %s to a TensorShape: %s." % (arg_name, e))
